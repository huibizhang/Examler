<template>
  <div
    class="w-full h-full flex justify-center items-center relative -top-full transition-all duration-500"
    :class="[
  ...
  >
    ...
    <div
      class="w-60 h-60 bg-white z-10 shadow-lg rounded-xl flex flex-col justify-center items-center gap-7"
    >
      題目努力讀取中 ...
