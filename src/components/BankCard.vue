<template>
  ...
  >
    ...
    <div class="flex-1 flex items-center p-3 font-bold text-lg dark:text-gray-300">
      {{title}}
    </div>
    <div class="w-8 h-full flex justify-center items-center text-gray-300 dark:text-gray-400 transition-all">
