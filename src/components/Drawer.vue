<template>
  ...
  >
    ...
    <div
      class="bg-white h-full w-2/3 absolute top-0 transition-all duration-500 shadow-xl"
      :class="[
    ...
    >
      ...
      <div class="p-3 space-y-2">
        ...
        >
          ...
          >
            <div>
              <svg v-if="link.link==='/exam/'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 800 800" stroke="currentColor">
              ...
              <svg v-else-if="link.link==='/'" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
